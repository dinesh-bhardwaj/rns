...
public class RnsApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(RnsApp.class);

    private final Environment env;

    public RnsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RnsApp.class);
